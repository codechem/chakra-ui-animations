...
var animationCollection = {
  "bounce-in": `${system.keyframes(bounce_in_default)}`,
  "bounce": `${system.keyframes(bounce_default)}`,
  "flash": `${system.keyframes(flash_default)}`,
  "head-shake": `${system.keyframes(head_shake_default)}`
};
